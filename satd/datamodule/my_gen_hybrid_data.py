        ...
        for i in range(len(words)):
            ...
            if i == 0 and words[i] in ['{', '}']:
                ...
                if words[i - 1] == '\\frac':
                    ...
                    labels.append([id, 'above', parent.id, parent.label])
                    ...
                    labels.append([id, 'inside', parent.id, '\sqrt'])
                    ...
                    if words[i - 2] != '}':
                        if words[i - 2] == '\sum':
                            labels.append(
                                [id, 'above', parent.id, parent.label])
                    ...
                    if words[i - 2] != '}':
                        if words[i - 2] == '\sum':
                            labels.append(
                                [id, 'below', parent.id, parent.label])
                            parents.append(Tree('\sum', id=parent.id))
                ...
                labels.append([id, 'l-sup', parent.id, '\sqrt'])
                parents.append(Tree('\sqrt', id=parent.id))
